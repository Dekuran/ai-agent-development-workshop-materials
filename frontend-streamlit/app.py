...
with st.sidebar:
    ...
    provider = st.selectbox("Provider / Framework", ["openai","anthropic","google","ollama","langchain","langgraph","smolagent","deepseek"])
    ...
    tools_available = ["web_search", "file_read", "sqlite_query"]
